...
public class UnsplitInvestmentPriceBaseObject {
	private static String logPath = "./log/TestLog/MarketPriceBackFeed/";
	private static String logName1 = "MissingRecord_DBI_UnSplitInvestmentPrice(BaseObject).log";
	private static String logName2 = "ContentChecking_DBI_UnsplitInvestmentPrice(BaseObject).log";
...
//Table DBI_DISTRIBUTION				
		...
		case tsMarketPrice:
			//CreateLogFile
			try {
				CustomizedLog.creatCusomizedLogFile(logPath, logName1, "MissingRecord_UnSplitInvestmentPrice");
				CustomizedLog.creatCusomizedLogFile(logPath, logName2, "ContentChecking_UnSplitInvestmentPrice");
	...
	//batch IDs testing once
				...
				tsdbValueMap = UnsplitInvestmentPriceBaseObjectUtil.getFullValueFromTsDB(tsType, tsType.TsType, sublist);				
				...
				try {
					netezzaValueMap = UnsplitInvestmentPriceBaseObjectUtil.getFullValueFromNetezza(tsType, Database.Netezza1, sublist, "DBI_UNSPLITINVESTMENTPRICE");
				} catch (SQLException e) {
	...
	public static void main(String[] args) throws TSException, Exception{
		...
		String tableName = "DBI_UNSPLITINVESTMENTPRICE";
