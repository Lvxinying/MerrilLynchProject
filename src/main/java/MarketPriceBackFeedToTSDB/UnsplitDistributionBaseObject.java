...
public class UnsplitDistributionBaseObject {
	private static String logPath = "./log/TestLog/MarketPriceBackFeed/";
	private static String logName1 = "MissingRecord_DBI_UnsplitDistribution(BaseObject).log";
	private static String logName2 = "ContentChecking_DBI_UnsplitDistribution(BaseObject).log";
...
//batch IDs testing once
				...
				tsdbValueMap = UnsplitDistributionBaseObjectUtil.getFullValueFromTsDB(tsType, tsType.TsType, sublist);				
				...
				try {
					netezzaValueMap = UnsplitDistributionBaseObjectUtil.getFullValueFromNetezza(tsType, Database.Netezza1, sublist, "DBI_UNSPLITDISTRIBUTION");
				} catch (SQLException e) {
