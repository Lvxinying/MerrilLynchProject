...
//Netteza
    	case Netezza1:
    		conn = connectToNetezza1();
    		break;
    	case Netezza2:
    		conn = connectToNetezza2();
    		break;
    	case Netezza3:
    		conn = connectToNetezza3();
    		break;
    	}
    	return conn;
    }  
...
//Vertica
    ...
    private static Connection connectToNetezza1(){
        // 得到当前线程上绑定的连接  
        Connection connNetezza1 = tl.get();
    	try {  
    			iniDbConfig("NetezzaQA");  
    			connNetezza1 = ds.getConnection();  
                tl.set(connNetezza1);   
            return connNetezza1;  
        } catch (Exception e) {  
            throw new RuntimeException(e);  
    ...
    private static Connection connectToNetezza2(){
        // 得到当前线程上绑定的连接  
        Connection connNetezza2 = tl.get();
    	try {  
    			iniDbConfig("NetezzaSTG");  
    			connNetezza2 = ds.getConnection();  
                tl.set(connNetezza2);   
            return connNetezza2;  
        } catch (Exception e) {  
            throw new RuntimeException(e);  
    ...
    private static Connection connectToNetezza3(){
        // 得到当前线程上绑定的连接  
        Connection connNetezza3 = tl.get();
    	try {  
    			iniDbConfig("NetezzaLIVE");  
    			connNetezza3 = ds.getConnection();  
                tl.set(connNetezza3);   
            return connNetezza3;  
        } catch (Exception e) {  
            throw new RuntimeException(e);  
