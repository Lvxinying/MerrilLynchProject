...
public class StockPackageCompleteTest {
	/**
	 * @param args
	 */
	...
	private static void testStockFileComplete(){
		int lineNum = 0;
		...
		System.out.println("[TestForCompletment]Stock package complete testing begins,please wait.......");
...
//Test no more or less 15 "~" symbol
	...
	public static void main(String[] args) {
		...
		System.out.println("[INFO]Complete test for Stock has finished, total cost: " + endTestTime + " ms");
	}
}
