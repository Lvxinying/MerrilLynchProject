...
public class FundPackageTest {
	...
	public static String testLogPath = "../TestLog/FundPackage/";
	...
	public static String FundfilePath = "../Package/PLP320XA.MSGBLFND";
...
//DB端数据准备		
		...
		String sqlToGetISIN  = "SELECT InvestmentId,ISIN FROM dbo.PerformanceIdDimension WHERE InvestmentId IN (" + performanceIdBuild + ")";
		...
		String sqlToGetProxyName = "SELECT InvestmentId,InvestmentName FROM dbo.InvestmentIdDimension WHERE InvestmentId IN (" + investmentIdBuild + ")";				
//File端数据准备
		String fileCUSIP = "";
		String fileSEDOL = "";
		String fileISIN = "";
